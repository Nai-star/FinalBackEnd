...
export default function PaginaPrincipal() {
  ...
  return (
    <div>
      ...
      >
        ...
        {menuOpen && (
          <div className="dropdown-content">
            <Link to="/servicio1">Servicio 1</Link>
            <Link to="/servicio2">Servicio 2</Link>
            <Link to="/servicio3">Servicio 3</Link>
          </div>
        )}
      </div>
      ...
      <svg className="usuario"  viewBox="0 0 25 24"  xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
      ...
      <svg className="carrito" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
